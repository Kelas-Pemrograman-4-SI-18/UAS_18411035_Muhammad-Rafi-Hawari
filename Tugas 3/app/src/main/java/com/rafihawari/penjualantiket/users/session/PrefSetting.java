package com.rafihawari.penjualantiket.users.session;
...
import com.rafihawari.penjualantiket.users.pembeli.HomePembeli;
...
public class PrefSetting {
    ...
    public void storeRegIdSharedPreferences(Context context, String _id, String userName, String namaLengkap, String email, String nomorTelp, String role, SharedPreferences prefs){
